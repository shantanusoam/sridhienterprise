  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <h2 className={`text-3xl font-bold mb-12 text-center text-${COLORS.primary}`}>Our Product Categories</h2>
              ...
              {categories.map((category, index) => (
                <div key={category.title} className="w-full flex-shrink-0 px-4">
                  <Card className="h-full">
                    ...
                    <CardContent>
                      <p className={`text-${COLORS.text}`}>Explore our wide range of {category.title.toLowerCase()} products.</p>
                    </CardContent>
                    <CardFooter>
                      <Button className={`w-full bg-${COLORS.secondary} hover:bg-${COLORS.primary} text-white`}>
                        View Products
                      </Button>
                    </CardFooter>
                  </Card>
